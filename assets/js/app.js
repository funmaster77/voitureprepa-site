  ...
  if (_currentPack.kind === "inspection") {
    ...
    openPaymentModal(montant,
      ...
      function () {
        ...
        alert("✅ Inspection " + ni.niveau + " payée (" + total + " €) pour " +
          selectedAds.length + " véhicule(s).\n\n" +
          "Vous serez notifié dès que des créneaux de rendez-vous seront proposés au garage choisi.\n\n" +
          "Suivi : Mon compte → onglet Inspections.");
      });
    return;
  }
