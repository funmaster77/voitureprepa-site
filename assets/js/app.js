...
function renderAdCard(ad) {
  ...
  const stageBadge = (ad.type === "voiture" && ad.stage && String(ad.stage).trim())
    ? `<span class="ad-stage-badge">${escHtml(ad.stage)}</span>`
    : "";
  ...
  const etatBadge = (function () {
    ...
    return `<span class="ad-etat-badge ${cls}">${escHtml(v)}</span>`;
  })();
  ...
  const chronoBadge = (ad.type === "voiture" && chronoVal > 0)
    ? `<div class="ad-chrono-badge" title="Chrono 100-200 km/h">
         <span class="ad-chrono-lbl">100-200</span>
         <span class="ad-chrono-val">${String(chronoVal).replace(".", ",")} s</span>
       </div>`
    : "";
  ...
  return `
    <div class="ad-card">
      <div class="ad-img" style="background-image:url('${ad.img}');" role="img" aria-label="Photo : ${escHtml(ad.titre)}">
        <div class="ad-badges">${badges}</div>
        ${chronoBadge}
        ${getProLogoForAd(ad) ? `<div class="ad-pro-logo" title="Annonce d'un professionnel"><img src="${getProLogoForAd(ad)}" alt="logo pro"></div>` : ""}
      ...
      <div class="ad-body">
        <div class="ad-price-row"><span class="ad-price">${prix} €</span>${stageBadge}</div>
        ${etatBadge}
        <a class="ad-title ad-card-link" href="${url}">${escHtml(ad.titre)}</a>
