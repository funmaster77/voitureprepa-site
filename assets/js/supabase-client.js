...
// ============================================================
async function sbSignUp({ email, password, type, prenom, nom, raison_sociale, siret, telephone, pack, pack_expires_at }) {
  // v17 — On transmet aussi `pack` et `pack_expires_at` (utilisés par le trigger handle_new_user)
  return sb.auth.signUp({
    email, password,
    options: {
      data: { type, prenom, nom, raison_sociale, siret, telephone, pack, pack_expires_at },
