...
module.exports = async (req, res) => {
  ...
  // Construit le lien vers la messagerie (la page profil ouvre l'onglet Messages via ?tab=messages)
          ...
          <tr>
            <td style="padding:32px 28px 8px 28px;">
              ...
              <p style="margin:0 0 20px;font-size:15px;line-height:1.5;color:#41506b;">
                <strong>${escapeHtml(sender_display_name)}</strong> vous a envoyé un message${ad_title ? " concernant l'annonce <strong>" + escapeHtml(ad_title) + "</strong>" : ""} sur VoiturePrepa.
              </p>
              ...
              <p style="margin:0 0 24px;font-size:14px;line-height:1.5;color:#41506b;">
                Pour répondre, ouvrez votre messagerie VoiturePrepa :
              </p>
              ...
              ${adUrl ? `<p style="margin:0 0 8px;font-size:13px;color:#7d8aa3;text-align:center;">
                <a href="${adUrl}" style="color:#0a2540;text-decoration:underline;">Voir l'annonce concernée</a>
              </p>` : ""}
            </td>
          </tr>
          <tr>
